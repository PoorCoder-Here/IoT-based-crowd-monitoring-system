...
labelsPath = "C:\\Users\\bhuva\\PycharmProjects\\Crowd monitor system\\Crowd monitoring system using CV\\yolo-coco\\coco.names"
LABELS = open(labelsPath).read().strip().split("\n")

# derive the paths to the YOLO weights and model configuration
weightsPath = "C:\\Users\\bhuva\\PycharmProjects\\Crowd monitor system\\Crowd monitoring system using CV\\yolo-coco\\yolov3.weights"
configPath = "C:\\Users\\bhuva\\PycharmProjects\\Crowd monitor system\\Crowd monitoring system using CV\\yolo-coco\\yolov3.cfg"
